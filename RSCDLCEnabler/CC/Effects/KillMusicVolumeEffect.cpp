...
namespace CrowdControl::Effects {
	...
	EffectResult KillMusicVolumeEffect::Start(Request request)
	{
		...
		WwiseVariables::Wwise_Sound_SetRTPCValue_Char("Mixer_Music", 0.0f, 0xffffffff, 0, AkCurveInterpolation_Linear);
		WwiseVariables::Wwise_Sound_SetRTPCValue_Char("Mixer_Music", 0.0f, 0x00001234, 0, AkCurveInterpolation_Linear);
