...
namespace RSMods
{
    public partial class MainForm : Form
    {
        ...
        private void FillToolTipDictionary()
        {
            ...
            if (checkBox_DropPedal != null)
                TooltipDictionary.Add(checkBox_DropPedal, "Enables the in-game drop pedal. Engine selection is in the Misc tab and changes require restarting Rocksmith.");
            ...
            if (comboBox_DropPedalEngine != null)
                TooltipDictionary.Add(comboBox_DropPedalEngine, "Automatic uses ASIO input shifting when available and Cable otherwise. Asio requires RS_ASIO. Cable never installs the ASIO input shifter.");
