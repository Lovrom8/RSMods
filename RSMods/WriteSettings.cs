    ...
    class WriteSettings
    {
        ...
        public static Dictionary<string, Dictionary<string, string>> saveSettingsOrDefaults = new Dictionary<string, Dictionary<string, string>>()
        {
            ...
            {"[Toggle Switches]", new Dictionary<string, string>
            {
                ...
                { ReadSettings.MidiSoftwareSettingsIdentifier, CreateDefaultOnOldINI(ReadSettings.MidiSoftwareSettingsIdentifier, "") }, // Used to configure a Software Tuning Pedal. Format: OffChannel, PC or CC, CC Channel (optional | defaults to 0). Ex: "0, CC, 20" will send a CC to channel 20 as defined in SoftwareTriggers, and when turning off it will send a CC 0 to channel 20.
