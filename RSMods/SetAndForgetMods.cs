...
#pragma warning disable IDE0059 // Unused assignment

namespace RSMods
{
    static class SetAndForgetMods
    {
        ...
        public static void AddCustomMenuAndDCMode()
        {
        ...
        private static void CopyFastLoadMod(bool NVMe)
        {
            if (NVMe)
        ...
        public static Tuple<string, bool> GetDriveType(char driveLetter) // This may not work on Win7, MSDN says its for >= Win8
        {
        ...
        public static void UnpackCacheAgain()
        {
            if (!Directory.Exists(Constants.CachePcPath))
                return;
