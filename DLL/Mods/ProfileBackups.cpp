...
SettingDefs ProfileBackupsMod::Settings() const {
	return {
		SettingDef::Toggle(Settings::Setting::BackupProfile, "BackupProfile", "Backup Profile", "GUI Settings", "Toggle Switches", "on")
			.Hint("Every time you play Rocksmith there is an extremely small chance your save can get corrupted.\n"
		...
		SettingDef::Toggle(Settings::Setting::FastProfileLoadAndSave, "FastProfileLoadAndSave", "Fast Profile Load/Save")
			...
			.WithVisibleWhen(Settings::Setting::BackupProfile),
	};
}
