...
namespace CrowdControl::EffectList {
	std::map<std::string, CCEffect*> AllEffects{
		...
		{ "halfsongspeed", new HighwayScrollSpeedEffect(30, 1.5) },
		{ "doublesongspeed", new HighwayScrollSpeedEffect(30, 10.0) },
		{ "triplesongspeed", new HighwayScrollSpeedEffect(30, 15.0) },
