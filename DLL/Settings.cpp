...
void Settings::Initialize()
{
	modSettings = {
		...
		{"LoopEndKey", "U"},
		{"RewindKey", "Z"},
		{"DropPedalDownKey", "VK_F9"},
		{"DropPedalUpKey", "VK_F10"},
...
void Settings::ReadKeyBinds() {
	...
	modSettings = {
		...
		{ "DropPedalDownKey", reader.GetValue("Keybinds", "DropPedalDownKey", "VK_F9")},
		{ "DropPedalUpKey", reader.GetValue("Keybinds", "DropPedalUpKey", "VK_F10")},
